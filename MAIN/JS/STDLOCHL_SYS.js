...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_LOCAL_HOLIDAY_MASTER":"BRANCH_CODE~YEAR~WEEKLY_HOLIDAYS~UNEXP_HOL~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH","BLK_LOCAL_HOLIDAY":"BRANCH_CODE~YEAR~MONTH~HOLIDAY_LIST"};

var multipleEntryPageSize = {"BLK_LOCAL_HOLIDAY" :"15" };

var multipleEntrySVBlocks = "";

var tabMEBlks = {"CVS_MAIN__TAB_MAIN":"BLK_LOCAL_HOLIDAY"};

var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_LOCAL_HOLIDAY_MASTER">BRANCH_CODE~YEAR~WEEKLY_HOLIDAYS~UNEXP_HOL~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH</FN>'; 
msgxml += '      <FN PARENT="BLK_LOCAL_HOLIDAY_MASTER" RELATION_TYPE="N" TYPE="BLK_LOCAL_HOLIDAY">BRANCH_CODE~YEAR~MONTH~HOLIDAY_LIST</FN>'; 
msgxml += '    </FLD>'; 
...
var msgxml_sum=""; 
msgxml_sum += '    <FLD>'; 
msgxml_sum += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_LOCAL_HOLIDAY_MASTER">AUTHSTAT~TXNSTAT~BRANCH_CODE~YEAR</FN>'; 
msgxml_sum += '    </FLD>'; 

var detailFuncId = "STDLOCHL";
var defaultWhereClause = "";
var defaultOrderByClause ="";
var multiBrnWhereClause ="";
var g_SummaryType ="S";
var g_SummaryBtnCount =0;
var g_SummaryBlock ="BLK_LOCAL_HOLIDAY_MASTER";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR DATABINDING *****
//----------------------------------------------------------------------------------------------------------------------
 var relationArray = {"BLK_LOCAL_HOLIDAY_MASTER" : "","BLK_LOCAL_HOLIDAY" : "BLK_LOCAL_HOLIDAY_MASTER~N"}; 

 var dataSrcLocationArray = new Array("BLK_LOCAL_HOLIDAY_MASTER","BLK_LOCAL_HOLIDAY"); 
...
//***** CODE FOR LOVs *****
//----------------------------------------------------------------------------------------------------------------------
var lovInfoFlds = {"BLK_LOCAL_HOLIDAY_MASTER__BRANCH_CODE__LOV_BRANCH":["BLK_LOCAL_HOLIDAY_MASTER__BRANCH_CODE~~","","N~N",""]};
...
//----------------------------------------------------------------------------------------------------------------------
var multipleEntryIDs = new Array("BLK_LOCAL_HOLIDAY");
...
//***** SCRIPT FOR ATTACHED CALLFORMS *****
 ...
 var CallFormArray= new Array("CSCFNUDF~BLK_LOCAL_HOLIDAY_MASTER"); 
...
ArrFuncOrigin["STDLOCHL"]="KERNEL";
ArrPrntFunc["STDLOCHL"]="";
ArrPrntOrigin["STDLOCHL"]="";
ArrRoutingType["STDLOCHL"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["STDLOCHL"]="N";
ArrCustomModified["STDLOCHL"]="N";
