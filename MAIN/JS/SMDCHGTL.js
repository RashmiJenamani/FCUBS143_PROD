 ...
 Caution Don't Delete this. This is used by the Version control utility.
	...
	********************************** START OF LOG HISTORY **************************************
	...
	Initial Checkin
	 ...
	 Changed By      : Anoop R
     Change Date     : 02-Jul-2014
     Change Reason   : Disable the Block Elements.	
     Search String   : 1203_19141514
	********************************** END   OF LOG HISTORY **************************************
...
function fnPostLoad() {
    ...
    mainWin.ValidateFlag = 'N';
    
    document.getElementById("cmdAddRow_BLK_SMVW_USERS_TIMELEVEL").style.visibility="hidden";
    document.getElementById("cmdDelRow_BLK_SMVW_USERS_TIMELEVEL").style.visibility="hidden";
    document.getElementById("BTN_SINGLE_VIEW_BLK_SMVW_USERS_TIMELEVEL").style.visibility="hidden";
}
/*
...
function fnPostUnlock() {
    ...
    //1203_19141514 Changes Start
    //fnEnableElement(document.getElementById("SMVWS_USERS_TIMELEVEL__TIME_LEVEL"));
    //document.getElementById("SMVWS_USERS_TIMELEVEL__TIME_LEVEL").focus();
      fnDisableElement(document.getElementById("SMVWS_USERS_TIMELEVEL__HOME_BRANCH"));
      fnDisableElement(document.getElementById("SMVWS_USERS_TIMELEVEL__TERMINAL"));
      disableBlockElements(document.getElementById("BLK_SMVW_USERS_TIMELEVEL"),"INPUT",true,false)
    //1203_19141514 Changes End
}
/*
