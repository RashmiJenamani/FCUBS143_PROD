...
function fnPostLoad() {
    ...
    document.getElementById("cmdAddRow_BLK_SMTB_TXN_STATUS").style.visibility = "hidden";
    document.getElementById("cmdDelRow_BLK_SMTB_TXN_STATUS").style.visibility = "hidden";
    document.getElementById("BTN_SINGLE_VIEW_BLK_SMTB_TXN_STATUS").style.visibility = "hidden";
}
