...
//----------------------------------------------------------------------------------------------------------------------
var fieldNameArray = {"BLK_CCY_HOL_MASTER":"CCY~YEAR~WEEKLY_HOLIDAYS~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH","BLK_CCY_HOLIDAY":"CCY~YEAR~MONTH~HOLIDAY_LIST"};

var multipleEntryPageSize = {"BLK_CCY_HOLIDAY" :"15" };

var multipleEntrySVBlocks = "";

var tabMEBlks = {"CVS_MAIN__TAB_MAIN":"BLK_CCY_HOLIDAY"};

var msgxml=""; 
msgxml += '    <FLD>'; 
msgxml += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_CCY_HOL_MASTER">CCY~YEAR~WEEKLY_HOLIDAYS~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH</FN>'; 
msgxml += '      <FN PARENT="BLK_CCY_HOL_MASTER" RELATION_TYPE="N" TYPE="BLK_CCY_HOLIDAY">CCY~YEAR~MONTH~HOLIDAY_LIST</FN>'; 
msgxml += '    </FLD>'; 
...
var msgxml_sum=""; 
msgxml_sum += '    <FLD>'; 
msgxml_sum += '      <FN PARENT="" RELATION_TYPE="1" TYPE="BLK_CCY_HOL_MASTER">AUTHSTAT~TXNSTAT~CCY~YEAR</FN>'; 
msgxml_sum += '    </FLD>'; 

var detailFuncId = "STDCYHOL";
var defaultWhereClause = "";
var defaultOrderByClause ="";
var multiBrnWhereClause ="";
var g_SummaryType ="S";
var g_SummaryBtnCount =0;
var g_SummaryBlock ="BLK_CCY_HOL_MASTER";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR DATABINDING *****
//----------------------------------------------------------------------------------------------------------------------
 var relationArray = {"BLK_CCY_HOL_MASTER" : "","BLK_CCY_HOLIDAY" : "BLK_CCY_HOL_MASTER~N"}; 

 var dataSrcLocationArray = new Array("BLK_CCY_HOL_MASTER","BLK_CCY_HOLIDAY"); 
...
//***** CODE FOR LOVs *****
//----------------------------------------------------------------------------------------------------------------------
var lovInfoFlds = {"BLK_CCY_HOL_MASTER__CCY__LOV_CCY_CODE":["BLK_CCY_HOL_MASTER__CCY~~","","N~N",""]};
...
//----------------------------------------------------------------------------------------------------------------------
var multipleEntryIDs = new Array("BLK_CCY_HOLIDAY");
...
//***** SCRIPT FOR ATTACHED CALLFORMS *****
 ...
 var CallFormArray= new Array("CSCFNUDF~BLK_CCY_HOL_MASTER"); 
...
ArrFuncOrigin["STDCYHOL"]="KERNEL";
ArrPrntFunc["STDCYHOL"]="";
ArrPrntOrigin["STDCYHOL"]="";
ArrRoutingType["STDCYHOL"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["STDCYHOL"]="N";
ArrCustomModified["STDCYHOL"]="N";
