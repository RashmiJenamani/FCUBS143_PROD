CREATE OR REPLACE PACKAGE  cspks_cscfnudf_kernel AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : cspks_cscfnudf_kernel.spc
  **
  ** Module     : Core
  **
...
END cspks_cscfnudf_kernel;
/
CREATE OR REPLACE SYNONYM cspkss_cscfnudf_kernel FOR cspks_cscfnudf_kernel
/