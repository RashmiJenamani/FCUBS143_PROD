CREATE OR REPLACE PACKAGE  stpks_stdcnmnt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcnmnt_main.spc
  **
...
TYPE ty_stdcnmnt IS RECORD (
     v_sttms_country     sttm_country%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcnmnt_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcnmnt_main FOR stpks_stdcnmnt_main
/