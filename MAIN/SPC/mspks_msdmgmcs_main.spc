CREATE OR REPLACE PACKAGE  mspks_msdmgmcs_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdmgmcs_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdmgmcs IS RECORD (
     v_mstms_mcs     mstm_mcs%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdmgmcs_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdmgmcs_main FOR mspks_msdmgmcs_main
/