CREATE OR REPLACE PACKAGE  rppks_rpdrpram_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : rppks_rpdrpram_main.spc
  **
...
TYPE ty_rpdrpram IS RECORD (
     v_rptms_parameters     rptm_parameters%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END rppks_rpdrpram_main;
/
CREATE OR REPLACE SYNONYM rppkss_rpdrpram_main FOR rppks_rpdrpram_main
/