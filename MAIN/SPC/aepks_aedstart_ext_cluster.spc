create or replace package aepks_aedstart_ext_cluster As
  /*-----------------------------------------------------------------------------------
  **
  ** File Name    :  aepks_aedstart_ext_cluster.Spc
  **
  ** Module       : AE
  **
   **
...
END aepks_aedstart_ext_cluster;
/
CREATE OR REPLACE SYNONYM aepkss_aedstart_ext_cluster for aepks_aedstart_ext_cluster
/