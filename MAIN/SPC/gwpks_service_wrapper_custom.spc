create or replace package gwpks_service_wrapper_custom  is
...
end gwpks_service_wrapper_custom;
/
Create or replace synonym gwpkss_service_wrapper_custom for gwpks_service_wrapper_custom
/