CREATE OR REPLACE PACKAGE  ispks_isdctmex_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdctmex_main.spc
  **
...
TYPE ty_isdctmex IS RECORD (
     v_istms_clearing_code     istm_clearing_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdctmex_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdctmex_main FOR ispks_isdctmex_main
/