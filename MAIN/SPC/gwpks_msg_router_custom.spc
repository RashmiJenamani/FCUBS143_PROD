CREATE OR REPLACE PACKAGE Gwpks_Msg_Router_Custom AS
...
END Gwpks_Msg_Router_Custom;
/
CREATE OR REPLACE SYNONYM Gwpkss_Msg_Router_Custom FOR Gwpks_Msg_Router_Custom
/
