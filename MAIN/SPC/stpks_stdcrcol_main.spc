CREATE OR REPLACE PACKAGE  stpks_stdcrcol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrcol_main.spc
  **
...
TYPE ty_stdcrcol IS RECORD (
     v_sttm_core_el_collat     sttm_core_el_collat%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrcol_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrcol_main FOR stpks_stdcrcol_main
/