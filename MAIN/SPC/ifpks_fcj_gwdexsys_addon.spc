CREATE OR REPLACE PACKAGE  ifpks_fcj_gwdexsys_addon AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : IFPKS_FCJ_GWDEXSYS_ADDON.SPC
  **
  ** Module     : Interfaces
  ** 
...
p_gwdexsys IN  OUT  ifpks_fcj_gwdexsys.ty_gwdexsys,
...
p_gwdexsys IN   ifpks_fcj_gwdexsys.ty_gwdexsys,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_action_code		IN  VARCHAR2,
p_gwdexsys IN   ifpks_fcj_gwdexsys.ty_gwdexsys,
p_prev_gwdexsys IN OUT ifpks_fcj_gwdexsys.ty_gwdexsys,
p_wrk_gwdexsys IN OUT  ifpks_fcj_gwdexsys.ty_gwdexsys,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_prev_gwdexsys IN ifpks_fcj_gwdexsys.ty_gwdexsys,
p_wrk_gwdexsys IN OUT  ifpks_fcj_gwdexsys.ty_gwdexsys,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END ifpks_fcj_gwdexsys_addon;
/
CREATE OR REPLACE SYNONYM ifpkss_fcj_gwdexsys_addon FOR ifpks_fcj_gwdexsys_addon
/