CREATE OR REPLACE PACKAGE  copks_codinlov_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : copks_codinlov_main.spc
  **
...
TYPE ty_codinlov IS RECORD (
     v_cstb_int_lov_info     cstb_int_lov_info%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END copks_codinlov_main;
/
CREATE OR REPLACE SYNONYM copkss_codinlov_main FOR copks_codinlov_main
/