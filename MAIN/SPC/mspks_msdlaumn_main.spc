CREATE OR REPLACE PACKAGE  mspks_msdlaumn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdlaumn_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdlaumn IS RECORD (
     v_mstm_ems_swift_lau_key     mstm_ems_swift_lau_key%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdlaumn_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdlaumn_main FOR mspks_msdlaumn_main
/