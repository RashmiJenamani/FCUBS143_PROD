CREATE OR REPLACE PACKAGE  mspks_msdfqmap_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdfqmap_main.spc
  **
...
TYPE ty_msdfqmap IS RECORD (
     v_mstbs_fw_incoming_routing     mstb_fw_incoming_routing%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdfqmap_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdfqmap_main FOR mspks_msdfqmap_main
/