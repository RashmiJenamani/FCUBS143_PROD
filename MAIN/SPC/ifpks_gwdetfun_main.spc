CREATE OR REPLACE PACKAGE  ifpks_gwdetfun_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ifpks_gwdetfun_main.spc
  **
  ** Module     : Interfaces
  ** 
...
TYPE ty_gwdetfun IS RECORD (
     v_gwtms_ext_sys_functions     gwtm_ext_sys_functions%ROWTYPE,
     v_gwtms_ext_sys_master     gwtm_ext_sys_master%ROWTYPE,
     v_gwtms_gateway_functions     gwtm_gateway_functions%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_gwdetfun  IN   OUT ifpks_gwdetfun_Main.ty_gwdetfun,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_gwdetfun          IN  ifpks_gwdetfun_Main.Ty_gwdetfun,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_gwdetfun       IN  OUT ifpks_gwdetfun_Main.Ty_gwdetfun,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ifpks_gwdetfun_main;
/
CREATE OR REPLACE SYNONYM ifpkss_gwdetfun_main FOR ifpks_gwdetfun_main
/