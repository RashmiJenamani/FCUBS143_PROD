CREATE OR REPLACE PACKAGE aepks_eoc_vals_custom IS
/**-----------------------------------------------------------------------------------------
**
** File Name   : aepks_eoc_vals_custom.spc
**
** Module      : AE
**
...
END aepks_eoc_vals_custom;
/
CREATE OR REPLACE SYNONYM aepkss_eoc_vals_custom for aepks_eoc_vals_custom
/