CREATE OR REPLACE PACKAGE  stpks_stdcracc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcracc_main.spc
  **
...
TYPE ty_stdcracc IS RECORD (
     v_sttms_core_account     sttm_core_account%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcracc_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcracc_main FOR stpks_stdcracc_main
/