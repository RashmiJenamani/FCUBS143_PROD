CREATE OR REPLACE PACKAGE  stpks_stdcscag_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcscag_main.spc
  **
...
TYPE ty_stdcscag IS RECORD (
     v_sttms_customer_cat     sttm_customer_cat%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcscag_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcscag_main FOR stpks_stdcscag_main
/