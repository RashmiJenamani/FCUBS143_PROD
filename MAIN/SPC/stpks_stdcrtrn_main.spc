CREATE OR REPLACE PACKAGE  stpks_stdcrtrn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrtrn_main.spc
  **
...
TYPE ty_stdcrtrn IS RECORD (
     v_sttms_core_trn_code     sttm_core_trn_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrtrn_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrtrn_main FOR stpks_stdcrtrn_main
/