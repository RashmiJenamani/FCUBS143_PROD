CREATE OR REPLACE PACKAGE  stpks_stdcrcln_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrcln_main.spc
  **
...
TYPE ty_stdcrcln IS RECORD (
     v_core_consumerloan_acc     sttm_core_consumerloan_acc%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrcln_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrcln_main FOR stpks_stdcrcln_main
/