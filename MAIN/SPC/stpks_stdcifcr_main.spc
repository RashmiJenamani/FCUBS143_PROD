CREATE OR REPLACE PACKAGE  stpks_stdcifcr_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcifcr_main.spc
  **
...
TYPE ty_stdcifcr IS RECORD (
     v_sttm_core_customer     sttm_core_customer%ROWTYPE,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_stdcifcr       IN  OUT stpks_stdcifcr_Main.Ty_stdcifcr,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcifcr_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcifcr_main FOR stpks_stdcifcr_main
/