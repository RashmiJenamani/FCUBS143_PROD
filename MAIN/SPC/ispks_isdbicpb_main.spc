CREATE OR REPLACE PACKAGE  ispks_isdbicpb_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdbicpb_main.spc
  **
...
TYPE ty_isdbicpb IS RECORD (
     v_istm_bic_directory_lcl     istm_bic_directory_lcl%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdbicpb_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdbicpb_main FOR ispks_isdbicpb_main
/