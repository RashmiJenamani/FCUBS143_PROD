CREATE OR REPLACE PACKAGE  gipks_gidcrcfn_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : gipks_gidcrcfn_main.spc
  **
...
TYPE ty_gidcrcfn IS RECORD (
     v_gitm_crc_checksum     gitm_crc_checksum%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END gipks_gidcrcfn_main;
/
CREATE OR REPLACE SYNONYM gipkss_gidcrcfn_main FOR gipks_gidcrcfn_main
/