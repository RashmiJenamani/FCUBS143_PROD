CREATE OR REPLACE PACKAGE  stpks_stdcrbnk_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrbnk_main.spc
  **
...
TYPE ty_stdcrbnk IS RECORD (
     v_sttms_core_bank     sttm_core_bank%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrbnk_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrbnk_main FOR stpks_stdcrbnk_main
/