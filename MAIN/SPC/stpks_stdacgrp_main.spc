CREATE OR REPLACE PACKAGE  stpks_stdacgrp_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdacgrp_main.spc
  **
...
TYPE ty_stdacgrp IS RECORD (
     v_sttms_access_group     sttm_access_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdacgrp_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdacgrp_main FOR stpks_stdacgrp_main
/