CREATE OR REPLACE PACKAGE gipks_in_pkg_generator_custom AS
/*------------------------------------------------------------------------------------------
...
RETURN BOOLEAN;
----Bug#29124530 ends---
END gipks_in_pkg_generator_custom;
/
CREATE OR REPLACE SYNONYM gipkss_in_pkg_generator_custom FOR gipks_in_pkg_generator_custom
/