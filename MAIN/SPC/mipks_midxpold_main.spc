CREATE OR REPLACE PACKAGE  mipks_midxpold_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mipks_midxpold_main.spc
  **
...
TYPE ty_midxpold IS RECORD (
     v_mitms_pool_code     mitm_pool_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mipks_midxpold_main;
/
CREATE OR REPLACE SYNONYM mipkss_midxpold_main FOR mipks_midxpold_main
/