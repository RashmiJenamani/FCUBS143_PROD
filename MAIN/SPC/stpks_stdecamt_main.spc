CREATE OR REPLACE PACKAGE  stpks_stdecamt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdecamt_main.spc
  **
...
TYPE ty_stdecamt IS RECORD (
     v_sttms_eca_system     sttm_eca_system%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdecamt_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdecamt_main FOR stpks_stdecamt_main
/