CREATE OR REPLACE PACKAGE  ispks_isdesban_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdesban_main.spc
  **
...
TYPE ty_isdesban IS RECORD (
     v_istb_isiban_directory     istb_isiban_directory%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdesban_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdesban_main FOR ispks_isdesban_main
/