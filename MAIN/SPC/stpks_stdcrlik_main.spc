CREATE OR REPLACE PACKAGE  stpks_stdcrlik_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrlik_main.spc
  **
...
TYPE ty_stdcrlik IS RECORD (
     v_sttm_core_el_liab_cust     sttm_core_el_liab_cust%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrlik_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrlik_main FOR stpks_stdcrlik_main
/