CREATE OR REPLACE PACKAGE  stpks_stdcrmca_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrmca_main.spc
  **
...
TYPE ty_stdcrmca IS RECORD (
     v_sttm_core_multi_ccy_accnt     sttm_core_multi_ccy_accnt%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrmca_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrmca_main FOR stpks_stdcrmca_main
/