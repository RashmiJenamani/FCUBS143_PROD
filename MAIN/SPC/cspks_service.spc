CREATE OR REPLACE PACKAGE cspks_service AS
/*------------------------------------------------------------------------------------------
**
...
---------------------------------------------------------------------------------------------------
   ...
   Changed By         :Radha
   Change Description :New Service Package for Both Maintenance and Online Screens
   -------------------------------------------------------------------------------------------------------
   */
   ...
   g_Levels CONSTANT PLS_INTEGER := 10;

   FUNCTION Fn_Process_Msg(p_Status    IN OUT VARCHAR2
                          ,p_Err_Code  IN OUT VARCHAR2
                          ,p_Err_Param IN OUT VARCHAR2) RETURN BOOLEAN;

END Cspks_Service;
/
CREATE OR REPLACE SYNONYM Cspkss_Service FOR Cspks_Service
/