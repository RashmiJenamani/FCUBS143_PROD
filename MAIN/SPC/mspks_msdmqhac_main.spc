CREATE OR REPLACE PACKAGE  mspks_msdmqhac_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdmqhac_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msdmqhac IS RECORD (
     v_ems_connectivity_line     mstm_ems_connectivity_line%ROWTYPE,
     v_mstm_ems_con_line_mqha     mstm_ems_con_line_mqha%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdmqhac_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdmqhac_main FOR mspks_msdmqhac_main
/