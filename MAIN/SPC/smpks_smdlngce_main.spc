CREATE OR REPLACE PACKAGE  smpks_smdlngce_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : smpks_smdlngce_main.spc
  **
...
TYPE ty_smdlngce IS RECORD (
     v_smtb_language     smtb_language%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END smpks_smdlngce_main;
/
CREATE OR REPLACE SYNONYM smpkss_smdlngce_main FOR smpks_smdlngce_main
/