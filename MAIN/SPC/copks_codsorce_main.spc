CREATE OR REPLACE PACKAGE  copks_codsorce_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : copks_codsorce_main.spc
  **
...
TYPE ty_codsorce IS RECORD (
     v_cotms_source     cotm_source%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END copks_codsorce_main;
/
CREATE OR REPLACE SYNONYM copkss_codsorce_main FOR copks_codsorce_main
/