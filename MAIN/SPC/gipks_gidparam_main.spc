CREATE OR REPLACE PACKAGE  gipks_gidparam_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : gipks_gidparam_main.spc
  **
...
TYPE ty_gidparam IS RECORD (
     v_gitb_param     gitb_param%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END gipks_gidparam_main;
/
CREATE OR REPLACE SYNONYM gipkss_gidparam_main FOR gipks_gidparam_main
/