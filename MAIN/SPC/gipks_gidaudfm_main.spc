CREATE OR REPLACE PACKAGE  gipks_gidaudfm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : gipks_gidaudfm_main.spc
  **
...
TYPE ty_gidaudfm IS RECORD (
     v_gitb_audf     gitb_audf%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END gipks_gidaudfm_main;
/
CREATE OR REPLACE SYNONYM gipkss_gidaudfm_main FOR gipks_gidaudfm_main
/