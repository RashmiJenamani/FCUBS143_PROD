CREATE OR REPLACE PACKAGE  mspks_msdqmap_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msdqmap_main.spc
  **
  ** Module     : MS
  ** 
...
TYPE ty_msdqmap IS RECORD (
     v_mstbs_incoming_routing     mstb_incoming_routing%ROWTYPE,
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source    IN     VARCHAR2,
                        ...
                        p_Wrk_msdqmap  IN   OUT mspks_msdqmap_Main.ty_msdqmap,
...
FUNCTION Fn_Populate_Record_Master (p_Source            IN     VARCHAR2,
                        ...
                        p_Function_Id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
                        p_msdqmap          IN  mspks_msdqmap_Main.Ty_msdqmap,
...
FUNCTION Fn_Get_Key_Information (p_Source    IN  VARCHAR2, 
                        ...
                        p_Function_id       IN     VARCHAR2,
                        p_Action_Code       IN     VARCHAR2,
p_msdqmap       IN  OUT mspks_msdqmap_Main.Ty_msdqmap,
p_Err_Code          IN OUT VARCHAR2,
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msdqmap_main;
/
CREATE OR REPLACE SYNONYM mspkss_msdqmap_main FOR mspks_msdqmap_main
/