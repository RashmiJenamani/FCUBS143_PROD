CREATE OR REPLACE PACKAGE  stpks_stddates_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stddates_main.spc
  **
...
TYPE ty_stddates IS RECORD (
     v_sttm_dates     sttm_dates%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stddates_main;
/
CREATE OR REPLACE SYNONYM stpkss_stddates_main FOR stpks_stddates_main
/