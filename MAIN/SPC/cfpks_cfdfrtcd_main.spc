CREATE OR REPLACE PACKAGE  cfpks_cfdfrtcd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : cfpks_cfdfrtcd_main.spc
  **
  ** Module     : The ICCF
  ** 
...
TYPE ty_cfdfrtcd IS RECORD (
     v_cftms_floating_rate_code     cftm_floating_rate_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END cfpks_cfdfrtcd_main;
/
CREATE OR REPLACE SYNONYM cfpkss_cfdfrtcd_main FOR cfpks_cfdfrtcd_main
/