CREATE OR REPLACE PACKAGE  aepks_aedstart_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : aepks_aedstart_main.spc
  **
...
FUNCTION Fn_Sys_Query_Desc_Fields  ( p_Source            IN     VARCHAR2,
                                     ...
                                     p_Wrk_aedstart  IN   OUT aepks_aedstart_Main.ty_aedstart,
...
END aepks_aedstart_main;
/
CREATE OR REPLACE SYNONYM aepkss_aedstart_main FOR aepks_aedstart_main
/