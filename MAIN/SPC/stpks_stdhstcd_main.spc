CREATE OR REPLACE PACKAGE  stpks_stdhstcd_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdhstcd_main.spc
  **
...
TYPE ty_stdhstcd IS RECORD (
     v_sttms_host_code     sttm_host_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdhstcd_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdhstcd_main FOR stpks_stdhstcd_main
/