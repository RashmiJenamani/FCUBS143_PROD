CREATE OR REPLACE PACKAGE  mipks_midxcode_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mipks_midxcode_main.spc
  **
...
TYPE ty_midxcode IS RECORD (
     v_mitms_cost_code     mitm_cost_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mipks_midxcode_main;
/
CREATE OR REPLACE SYNONYM mipkss_midxcode_main FOR mipks_midxcode_main
/