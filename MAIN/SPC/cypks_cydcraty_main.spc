CREATE OR REPLACE PACKAGE  cypks_cydcraty_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : cypks_cydcraty_main.spc
  **
  ** Module     : The ccy
  ** 
...
TYPE ty_cydcraty IS RECORD (
     v_cytms_rate_type     cytm_rate_type%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END cypks_cydcraty_main;
/
CREATE OR REPLACE SYNONYM cypkss_cydcraty_main FOR cypks_cydcraty_main
/