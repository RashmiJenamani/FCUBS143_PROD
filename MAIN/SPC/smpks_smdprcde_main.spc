CREATE OR REPLACE PACKAGE  smpks_smdprcde_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : smpks_smdprcde_main.spc
  **
...
TYPE ty_smdprcde IS RECORD (
     v_smtms_process_codes     smtm_process_codes%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END smpks_smdprcde_main;
/
CREATE OR REPLACE SYNONYM smpkss_smdprcde_main FOR smpks_smdprcde_main
/