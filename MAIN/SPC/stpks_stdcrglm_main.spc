CREATE OR REPLACE PACKAGE  stpks_stdcrglm_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrglm_main.spc
  **
...
TYPE ty_stdcrglm IS RECORD (
     v_sttm_core_glmaster     sttm_core_glmaster%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrglm_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrglm_main FOR stpks_stdcrglm_main
/