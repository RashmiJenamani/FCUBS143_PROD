CREATE OR REPLACE PACKAGE  mipks_midgrpmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mipks_midgrpmt_main.spc
  **
...
TYPE ty_midgrpmt IS RECORD (
     v_mitms_mis_group     mitm_mis_group%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mipks_midgrpmt_main;
/
CREATE OR REPLACE SYNONYM mipkss_midgrpmt_main FOR mipks_midgrpmt_main
/