CREATE OR REPLACE PACKAGE  stpks_stdcrpol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrpol_main.spc
  **
...
TYPE ty_stdcrpol IS RECORD (
     v_sttm_core_el_pool     sttm_core_el_pool%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrpol_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrpol_main FOR stpks_stdcrpol_main
/