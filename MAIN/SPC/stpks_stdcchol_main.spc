CREATE OR REPLACE PACKAGE  stpks_stdcchol_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcchol_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcchol_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcchol_main FOR stpks_stdcchol_main
/