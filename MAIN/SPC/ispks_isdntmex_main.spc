CREATE OR REPLACE PACKAGE  ispks_isdntmex_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdntmex_main.spc
  **
...
TYPE ty_isdntmex IS RECORD (
     v_istms_network_code     istm_network_code%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdntmex_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdntmex_main FOR ispks_isdntmex_main
/