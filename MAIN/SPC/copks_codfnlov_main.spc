CREATE OR REPLACE PACKAGE  copks_codfnlov_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : copks_codfnlov_main.spc
  **
...
TYPE ty_codfnlov IS RECORD (
     v_cstm_ext_lov_fid_info     cstm_ext_lov_fid_info%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END copks_codfnlov_main;
/
CREATE OR REPLACE SYNONYM copkss_codfnlov_main FOR copks_codfnlov_main
/