CREATE OR REPLACE PACKAGE  mspks_msddebrl_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : mspks_msddebrl_main.spc
  **
  ** Module     : Messaging
  ** 
...
TYPE ty_msddebrl IS RECORD (
     v_mstm_ems_debulk_rule     mstm_ems_debulk_rule%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END mspks_msddebrl_main;
/
CREATE OR REPLACE SYNONYM mspkss_msddebrl_main FOR mspks_msddebrl_main
/