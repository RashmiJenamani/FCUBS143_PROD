CREATE OR REPLACE PACKAGE  smpks_smdfndsc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : smpks_smdfndsc_main.spc
  **
...
TYPE ty_tb_mtb_function_description IS TABLE OF smtb_function_description%ROWTYPE INDEX BY BINARY_INTEGER;
TYPE ty_tb_v_smtb_duplicate_fields IS TABLE OF smtb_duplicate_fields%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_smdfndsc IS RECORD (
     v_smtb_menu     smtb_menu%ROWTYPE,
     v_smtb_function_description    ty_tb_mtb_function_description,
     v_smtb_duplicate_fields    ty_tb_v_smtb_duplicate_fields,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END smpks_smdfndsc_main;
/
CREATE OR REPLACE SYNONYM smpkss_smdfndsc_main FOR smpks_smdfndsc_main
/