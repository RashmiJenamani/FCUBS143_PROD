CREATE OR REPLACE PACKAGE  stpks_stdcrfac_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdcrfac_main.spc
  **
...
TYPE ty_stdcrfac IS RECORD (
     v_sttm_core_el_facility     sttm_core_el_facility%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_stdcrfac_main;
/
CREATE OR REPLACE SYNONYM stpkss_stdcrfac_main FOR stpks_stdcrfac_main
/