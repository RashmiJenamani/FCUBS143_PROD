CREATE OR REPLACE PACKAGE  stpks_fcj_stddates_addon AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : STPKS_FCJ_STDDATES_ADDON.SPC
  **
...
p_stddates IN  OUT  stpks_fcj_stddates.ty_stddates,
...
p_stddates IN   stpks_fcj_stddates.ty_stddates,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_action_code		IN  VARCHAR2,
p_stddates IN   stpks_fcj_stddates.ty_stddates,
p_prev_stddates IN OUT stpks_fcj_stddates.ty_stddates,
p_wrk_stddates IN OUT  stpks_fcj_stddates.ty_stddates,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
p_prev_stddates IN stpks_fcj_stddates.ty_stddates,
p_wrk_stddates IN OUT  stpks_fcj_stddates.ty_stddates,
p_err_code       IN  OUT VARCHAR2,
p_err_params     IN  OUT VARCHAR2)
RETURN BOOLEAN;
...
END stpks_fcj_stddates_addon;
/
CREATE OR REPLACE SYNONYM stpkss_fcj_stddates_addon FOR stpks_fcj_stddates_addon
/