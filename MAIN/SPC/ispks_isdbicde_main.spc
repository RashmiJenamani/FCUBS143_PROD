CREATE OR REPLACE PACKAGE  ispks_isdbicde_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : ispks_isdbicde_main.spc
  **
...
TYPE ty_isdbicde IS RECORD (
     v_istms_bic_directory     istm_bic_directory%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END ispks_isdbicde_main;
/
CREATE OR REPLACE SYNONYM ispkss_isdbicde_main FOR ispks_isdbicde_main
/