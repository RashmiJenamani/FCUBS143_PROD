CREATE OR REPLACE PACKAGE ispks_bic_upload_new_custom AS
...
--Bug#25266870 starts
  FUNCTION Fn_process(P_source_code  IN  VARCHAR2,
    ...
    RETURN BOOLEAN;
--Bug#25266870 ends 	
END ispks_bic_upload_new_custom;
/
CREATE OR REPLACE SYNONYM ispkss_bic_upload_new_custom FOR ispks_bic_upload_new_custom
/