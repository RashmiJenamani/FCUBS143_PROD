CREATE OR REPLACE PACKAGE  gipks_gidifprc_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : gipks_gidifprc_main.spc
  **
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END gipks_gidifprc_main;
/
CREATE OR REPLACE SYNONYM gipkss_gidifprc_main FOR gipks_gidifprc_main
/