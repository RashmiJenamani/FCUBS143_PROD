CREATE OR REPLACE PACKAGE  smpks_smddptmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : smpks_smddptmt_main.spc
  **
...
TYPE ty_smddptmt IS RECORD (
     v_smtbs_department     smtb_department%ROWTYPE,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END smpks_smddptmt_main;
/
CREATE OR REPLACE SYNONYM smpkss_smddptmt_main FOR smpks_smddptmt_main
/