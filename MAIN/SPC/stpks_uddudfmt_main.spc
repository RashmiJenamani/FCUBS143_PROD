CREATE OR REPLACE PACKAGE  stpks_uddudfmt_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_uddudfmt_main.spc
  **
...
TYPE ty_tb_v_udtms_lov IS TABLE OF udtm_lov%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_uddudfmt IS RECORD (
     v_udtms_fields     udtm_fields%ROWTYPE,
     v_udtms_lov    ty_tb_v_udtms_lov,
...
p_Err_Params        IN OUT VARCHAR2)
RETURN BOOLEAN;
END stpks_uddudfmt_main;
/
CREATE OR REPLACE SYNONYM stpkss_uddudfmt_main FOR stpks_uddudfmt_main
/