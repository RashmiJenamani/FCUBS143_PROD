CREATE OR REPLACE PACKAGE Gipks_Interface_Trigger_Custom IS

  /*----------------------------------------------------------------------------------------------------
    **
    ** File Name        : Gipks_Interface_Trigger_Custom.SQL
    ** Module            : GI
    **
  ...
  */
  FUNCTION Fn_Process_Incoming(p_Source         IN Cotms_Source.Source_Code%TYPE,
		 ...
		 --p_Gidifprs       IN OUT Gipks_Fcj_Gidifprs.Ty_Gidifprs,--14_1#GIDIFPRS_NON_EXT_TO_EXTCommented
  ...
  RETURN BOOLEAN;
   --#19157634 GI HOOK changes starts
    ...
    FUNCTION fn_process_in_file(p_source      IN cotms_source.source_code%TYPE,
			      ...
			      --p_gidifprs    IN OUT gipks_fcj_gidifprs.ty_gidifprs,--14_1#GIDIFPRS_NON_EXT_TO_EXTCommented
                        ...
                        p_Tb_Custom_Data IN OUT Global.Ty_Tb_Custom_Data,
                              ...
                              P_FP_failed_once in out number)
 RETURN BOOLEAN;
...
END Gipks_Interface_Trigger_Custom;
/
