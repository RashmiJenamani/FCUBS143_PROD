create or replace package cspks_req_utils_cluster as
   /*------------------------------------------------------------------------------------------
...
END cspks_req_utils_cluster;
/
CREATE or REPLACE SYNONYM cspkss_req_utils_cluster FOR cspks_req_utils_cluster
/